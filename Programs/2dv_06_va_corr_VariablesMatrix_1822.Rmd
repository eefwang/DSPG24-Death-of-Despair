...
corr_data <- virginia_2018_2022 %>%
  mutate(
    ...
    unemployed_pop = as.numeric(as.character(unemployed_pop)),
  ...
  select(Median_household_income, per_capita_income, unemployed_pop, Adult_smoking, DOD_death_rate, VDH_death_rate, BA_higher_ratio, Poor_fair_health, Children_in_poverty, below_poverty_ratio)
...
corrplot(corr_matrix, method = "color", type = "lower", col = corr_colors, 
         title = "VA Variables Correlation Plot", mar = c(0, 2, 2, 4),  # Increase right margin
