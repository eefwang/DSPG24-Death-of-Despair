...
corr_data <- appalachia_2018_2022 %>%
  ...
  select(public_admin, other_services, edu_health_social,
         ...
         manufacturing, construction, agriculture_mining, DOD_death_rate)
...
colnames(corr_data) <- c("Public Admin", "Other Services", "Education, Health, Social",
                         ...
                         "Retail Trade", "Wholesale Trade", "Manufacturing", "Construction", "Agriculture, Mining", "DOD Death Rate")
...
corrplot(corr_matrix, method = "color", type = "lower", col = corr_colors, 
         title = "Appalachia Occupations Correlation Matrix", mar = c(0, 2, 2, 4),  # Increase right margin
...
# Add a caption
mtext("Data obtained from the American Community Survey", 
