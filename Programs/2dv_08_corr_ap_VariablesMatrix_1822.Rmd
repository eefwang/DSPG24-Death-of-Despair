...
corr_data <- appalachia_2018_2022 %>%
  ...
  select(mean_household_income, unemployed_pop, BA_higher_ratio, below_poverty_ratio, total_DSW, RUCC_2023, DOD_death_rate)
...
corrplot(corr_matrix, method = "color", type = "lower", col = corr_colors, 
         title = "Appalachia Variables Correlation Plot", mar = c(0, 2, 2, 4),  # Increase right margin
