...
```{r import}
appalachia_2018_2022 = read.csv(here("Data/merged_data","appalachia_2018_2022.csv"))
virginia_2018_2022 = read.csv(here("Data/merged_data","virginia_2018_2022.csv"))
```
...
#Export data
```{r export, eval=FALSE}
write.csv(va_jobs_2018_2022, 
          file = here("Data/merged_data", "va_jobs_2018_2022.csv"),
          row.names = FALSE) 

write.csv(app_jobs_2018_2022, 
          file = here("Data/merged_data", "app_jobs_2018_2022.csv"),
          row.names = FALSE) 
```
