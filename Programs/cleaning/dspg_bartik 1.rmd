...
for (y in 2015:2018) {
  ...
  got.it <- get_acs(geography = 'county', year = y, variables = c('DP05_0001', 'DP03_0062', 'DP02_0066P', 'DP02_0067P', 'DP03_0009P', 'DP02_0082P', 'DP03_0019', 'DP03_0021', 'DP04_0001', 'DP03_0033', 'DP03_0034', 'DP03_0035', 'DP03_0036', 'DP03_0037', 'DP03_0038', 'DP03_0039', 'DP03_0040', 'DP03_0041', 'DP03_0042', 'DP03_0043', 'DP03_0044', 'DP03_0045'))
...
got.it <- get_acs(geography = 'county', year = 2019, variables = c('DP05_0001', 'DP03_0062', 'DP02_0067P', 'DP02_0068P', 'DP03_0009P', 'DP02_0083P', 'DP03_0019', 'DP03_0021', 'DP04_0001', 'DP03_0033', 'DP03_0034', 'DP03_0035', 'DP03_0036', 'DP03_0037', 'DP03_0038', 'DP03_0039', 'DP03_0040', 'DP03_0041', 'DP03_0042', 'DP03_0043', 'DP03_0044', 'DP03_0045'))

got.it <- as.data.frame(cbind(got.it, rep(2019, nrow(got.it))))
colnames(got.it)[ncol(got.it)] <- 'Year'
us_2015_2019 <- rbind(us_2015_2019, got.it)
...
for (y in 2015:2018) {
  ...
  for (c in unique(us_2015_2019$GEOID)) {
    ...
    ed <- c(ed, tmp21[which(tmp21$variable == 'DP02_0067P'),]$estimate[1])
    ed2 <- c(ed2, tmp21[which(tmp21$variable == 'DP02_0066P'),]$estimate[1])
    emp <- c(emp, tmp21[which(tmp21$variable == 'DP03_0009P'),]$estimate[1])
    movers <- c(movers, tmp21[which(tmp21$variable == 'DP02_0082P'),]$estimate[1])
...
tmp <- us_2015_2019 %>% filter(Year == 2019)
