...
# Loop through each period, fetch data, and reshape
...
list_data <- lapply(year, function(year) {
  data <- get_acs(
    ...
    variables = c(#education
      ...
      total_native_pop= "DP05_0039PE", total_black_pop="DP05_0038PE",
      total_white_pop="DP05_0037PE", foreign_born="DP02_0092PE", US_born="DP02_0088PE",
      #Income and Housing
      ...
      not_in_labor_force_pe= "DP03_0007PE", not_in_labor_force_pe= "DP03_0007PE",
...
edu_data_1518 <- bind_rows(list_data) 
edu_data_1518 <- edu_data_1518 %>%
  ...
  select(Year, State_fip, County.Code, County, total_asian_pacific_pop, DSW_male, DSW_female,
         ...
         total_female_pop, total_male_pop, total_pacific_pop, total_asian_pop, total_native_pop,
         total_black_pop, total_white_pop, foreign_born, US_born, total_housing_unitsE, per_capita_income,
...
data <- get_acs(
  ...
  variables = c(#education
    ...
    total_pacific_pop="DP05_0052PE", total_asian_pop="DP05_0044PE",
    total_native_pop= "DP05_0039PE", total_black_pop="DP05_0038PE",
    total_white_pop="DP05_0037PE", foreign_born="DP02_0093PE", US_born="DP02_0089PE",
    #Income and Housing
    total_housing_units="B25001_001", per_capita_income="DP03_0088E",
    mean_household_income="DP03_0063E",                  
    #POVERTY 	
    ...
    management_pe="DP03_0027PE", armed_forces_pe="DP03_0006PE",
    unemployed_pop_pe="DP03_0005PE", employed_pop_pe="DP03_0004PE",
    veterans_pe="DP02_0069PE", not_in_labor_force_pe= "DP03_0007PE",
    #industry estimates
    public_admin="DP03_0045E", other_services="DP03_0044E",
    arts_ent_rec="DP03_0043E", edu_health_social="DP03_0042E",
    prof_scientific="DP03_0041E", finance_insurance="DP03_0040E",
...
data <- get_acs(
  ...
  variables = c(#education
    ...
    total_pacific_pop="DP05_0052PE", total_asian_pop="DP05_0044PE",
    total_native_pop= "DP05_0039PE", total_black_pop="DP05_0038PE",
    total_white_pop="DP05_0037PE", foreign_born="DP02_0094PE", US_born="DP02_0090PE",
    #Income and Housing
    total_housing_units="B25001_001", per_capita_income="DP03_0088E",
    mean_household_income="DP03_0063E",                  
    #POVERTY 	
