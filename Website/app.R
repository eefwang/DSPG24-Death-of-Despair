                            ...
                            tabPanel("Overview", 
                                     fluidRow(style = "font-family: 'Times New Roman', Times, serif;",
                                              ...
                                              column(width = 5,
                                                  ...
                                                  demographic factors such as race and age group, median household income, healthcare 
                                                  accessibility, and proximity to mental health institutions and rehabilitation centers,
                                                  ...
                                                  under-researched demographics, particularly in relation to race, age, and education level."
                                                       ),
                            ...
                            tabPanel("Factors Dashboard", 
                                     fluidRow(style = "font-family: 'Times New Roman', Times, serif;",
                                              column(width = 12,
                                                  ...
                                                  such as educational attainment (BA or higher), unemployment rates, mean and median household
                                                  ...
                                                  and poverty rates can increase stress and reduce access to essential resources. By analyzing
                                                  these factors, we aim to understand how they influence the rates of deaths of despair in the
                                                  Virginia region, shedding light on the broader social and economic context of this public health issue.")
                                                     )
                                              )
                                     ),
                                       ...
                                       tabPanel("Legislation",
                                                ...
                                                fluidRow(
                                                  ...
                                                  column(6,
                                                         ...
                                                         p(style = " margin-left: 50px; margin-right: 50px; font-size: 16px; font-family: 'Times New Roman', Times, serif;",
                                                           "Virginia's Good Samaritan Law protects individuals who render emergency assistance in good faith 
                                                            during an overdose situation from civil liability. This encourages bystanders to seek help without 
                                                            fear of legal repercussions, potentially saving lives.")
                                                  )
                                                ),
                                                div(style = "margin-top: 30px;")
                                       )
                                     ...
                                     fluidRow(style = "font-family: 'Times New Roman', Times, serif;",
                                              ...
                                              column(width = 12,
                                                     ...
                                                     fluidRow(style = "margin-left: 50px; margin-right: 50px; text-align: center;",
                                                         ...
                                                         to as factors, such as educational attainment (BA or higher), unemployment rates, 
                                     ...
                                     fluidRow(style = "margin-left: 50px; margin-right: 50px;margin-top:20px; font-family: 'Times New Roman', Times, serif;",
                                              ...
                                              column(width = 4,
                                                     ...
                                                     fluidRow(
                                                       ...
                                                       p(style = "font-size: 16px; margin-left: 50px; margin-right: 50px;", 
                                     ...
                                     fluidRow(style = "margin-left: 50px; margin-right: 50px; font-family: 'Times New Roman', Times, serif;",
                                              ...
                                              p(style = "text-align: left; font-size: 16px;", "Where:",
                                                tags$ul(
                                                  ...
                                                  tags$li(HTML("Y<sub>it</sub>  is the dependent variable indicates the death rate per 100,000 population in county i and year t.")),
                                                  ...
                                                  tags$li(HTML("ϵ<sub>it</sub>  is the regression error term, capturing all other factors that influence [Equation]Yit  but are not included in the model.")),
                                                )
                                              ),
                                              p(style = "font-size: 16px; text-align: left;",
                                                "The dependent variable in our multivariate regression is the deaths of despair rates per 100,000 population across 
                                                Virginia counties. The independent variables include poverty rates, unemployment rates, and educational attainment 
                                                rates (Bachelor's degree or higher) for each county. We also include various control variables such as race, sex, 
                                                and fixed effects for year and Health Service Provider Area (HSPA) codes. The fixed effects in our model determine 
                                                if certain factors (such as categories or groups) have a significant impact compared to a baseline group. Fixed 
                                                effects account for the differences between factors that remain constant over time."),
                                              div(style = "margin-top: 30px;"),
                 ...
                 tabPanel("Meet the Team", 
                          ...
                          fluidRow(style = "margin: 12px; font-size: 16px; font-family: 'Times New Roman', Times, serif;", align = "center",
                                   ...
                                   column(4,
                                          div(
                                            style = "display: flex; justify-content: center;",
                                            img(src = "IsabelBradburn.jpg", width = "400px"), 
                                          ),
                                          div(style = "margin-top: 20px;"),
                                          p(strong("Dr. Isabel Bradburn")),
                                          p(em("Virginia Tech")),
                                          p("Associate Director"),
                                          p("Strategic & Faculty Initiatives")),
                                   column(4,
                                          div(
                                            style = "display: flex; justify-content: center;",
